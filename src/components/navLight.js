...
import logo from '../assets/icons/iitb.png';
    ...
    return(
        <nav className={`navbar ${scroll ? 'is-sticky' : ''}`} id="navbar">
            <div className="container relative flex flex-wrap items-center justify-between">
                ...
                <img src={logo} width={80} height={80} className="inline-block dark:hidden" alt=""/>
                ...
                <div className={`navigation lg_992:order-1 lg_992:flex  ms-auto ${manu ? '' : 'hidden'}`} id="menu-collapse">
                    <ul className="navbar-nav nav-light sidebar-nav" id="navbar-navlist">
                        ...
                        <li className="nav-item">
                            <Link1 className="nav-link ms-0" to="services" smooth={true} duration={1000} activeClass='active' spy={true}>Facilities</Link1>
                        </li>
                        <li className="nav-item">
                            <Link1 className="nav-link ms-0" to="projects" smooth={true} duration={1000} activeClass='active' spy={true}>Projects</Link1>
                        </li>
                        <li className="nav-item">
                            <Link1 className="nav-link ms-0" to="pricing" smooth={true} duration={1000} activeClass='active' spy={true}>Careers</Link1>
                        </li>
                        <li className="nav-item">
                            <Link1 className="nav-link ms-0" to="blog" smooth={true} duration={1000} activeClass='active' spy={true}>Achievements</Link1>
                        </li>
                        <li className="nav-item">
