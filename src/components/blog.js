    ...
    return(
        ...
        <div className="container relative">
            <div className="grid grid-cols-1 pb-6 text-center">
                <h3 className="font-semibold text-2xl leading-normal mb-4">Wall of Achievements</h3>

                <p className="text-slate-400 max-w-xl mx-auto">At Drone Center, we are proud of the numerous accolades and breakthroughs we've achieved in the field of drone technology.</p>
            </div>
