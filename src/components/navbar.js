        ...
        <nav className={`navbar ${scroll ? 'is-sticky' : ''}`} id="navbar">
            <div className="container relative flex flex-wrap items-center justify-between">
                <Link className="navbar-brand md:me-8" to="/">
                    <img src={logo} className="inline-block dark:hidden" alt=""/>
                ...
                <div className={`navigation lg_992:order-1 lg_992:flex  ms-auto ${manu ? '' : 'hidden'}`} id="menu-collapse">
                    <ul className="navbar-nav" id="navbar-navlist">
                        ...
                        <li className="nav-item ms-0">
                            <Link1 className="nav-link" to="services" smooth={true} duration={1000} activeClass='active' spy={true}>Facilities</Link1>
                        </li>
                        <li className="nav-item ms-0">
                            <Link1 className="nav-link" to="projects" smooth={true} duration={1000} activeClass='active' spy={true}>Projects</Link1>
                        </li>
                        <li className="nav-item ms-0">
